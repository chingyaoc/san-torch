...
-- Data input settings
cmd:option('-input_img_train_h5','../HieCoAttenVQA/data/vqa_data_img_vgg_train.h5','path to the h5file containing the image feature')
cmd:option('-input_img_test_h5','../HieCoAttenVQA/data/vqa_data_img_vgg_test.h5','path to the h5file containing the image feature')
cmd:option('-input_ques_h5','../HieCoAttenVQA/data/vqa_data_prepro.h5','path to the h5file containing the preprocessed dataset')
cmd:option('-input_json','../HieCoAttenVQA/data/vqa_data_prepro.json','path to the json file containing additional info and vocab')
...
paths.mkdir(opt.checkpoint_path .. '_' .. 'test')
...
while true do
  ...
  if (iter % opt.save_checkpoint_every == 0 or iter == opt.max_iters) then
      ...
      local checkpoint_path = path.join(opt.checkpoint_path .. '_' .. 'test', 'model_id' .. opt.id .. '_iter'.. iter)
      ...
      local checkpoint_path = path.join(opt.checkpoint_path .. '_' .. 'test', 'checkpoint' .. '.json')
  ...
  if opt.optim == 'sgd' then
    sgd(eparams, grad_eparams, learning_rate, opt.optim_alpha, opt.optim_epsilon, e_optim_state)
    sgd(aparams, grad_aparams, learning_rate, opt.optim_alpha, opt.optim_epsilon, a_optim_state)
